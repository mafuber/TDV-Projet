...
d3.json("data.json", function(data) {
    ...
    var color = d3.scaleOrdinal()
        ...
        .range(["rgb(225, 150, 0)", "rgb(215, 124, 10)", "rgb(215, 125, 20)", "rgb(255, 130, 25)", "rgb(235, 155, 50)", "rgb(255, 130, 10)", "rgb(255, 180, 0)", "rgb(200, 150, 25)"])
    ...
    svg
        ...
        .text(function(d) {
            ...
            console.log(d.data.key.charAt(0).toUpperCase() + d.data.key.slice(1));
